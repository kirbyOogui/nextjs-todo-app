  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 sm:flex-row">
      ...
      <input
        ...
        className="rounded-lg border border-black/10 bg-white px-4 py-3 text-base text-zinc-900 outline-none transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 dark:border-white/15 dark:bg-zinc-900 dark:text-zinc-50 dark:[color-scheme:dark]"
      />
      <button
        type="submit"
        disabled={isEmpty}
